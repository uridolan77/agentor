...
Stabilize the extracted PR1 starter into a green baseline. Fix compile/test issues only. No new features.
...
```text
Implement PR01 — Runtime foundation stabilization.
...
- docs/planning/pr1-pr40/prs/PR01-runtime-foundation-stabilization.md
