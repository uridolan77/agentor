...
Make the PR1 HTTP surface stable with v1 routes, response envelopes, error DTOs, OpenAPI metadata, and endpoint tests.
...
```text
Implement PR02 — API contract hardening and DTO versioning.
...
- docs/planning/pr1-pr40/prs/PR02-api-contract-hardening.md
