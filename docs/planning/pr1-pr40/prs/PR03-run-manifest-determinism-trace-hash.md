...
Add manifest versioning, deterministic ordering, trace hash, and summary hashes for audit/regression.
...
```text
Implement PR03 — Run manifest determinism and trace hash.
...
- docs/planning/pr1-pr40/prs/PR03-run-manifest-determinism-trace-hash.md
