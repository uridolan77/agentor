...
Add typed runtime/tool/policy options with startup validation and docs.
...
```text
Implement PR05 — Configuration/options model and startup validation.
...
- docs/planning/pr1-pr40/prs/PR05-configuration-options-startup-validation.md
