...
Prepare persistence abstractions and EF mapping design while keeping default local mode in-memory.
...
```text
Implement PR06 — EF Core persistence boundary.
...
- docs/planning/pr1-pr40/prs/PR06-ef-core-persistence-boundary.md
