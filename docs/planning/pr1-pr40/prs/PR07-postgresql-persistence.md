...
Persist runs, steps, tool calls, policy decisions, and trace events to PostgreSQL while preserving in-memory tests.
...
```text
Implement PR07 — PostgreSQL persistence implementation.
...
- docs/planning/pr1-pr40/prs/PR07-postgresql-persistence.md
