...
Add query endpoints for run lists, run detail, traces, steps, and tool calls.
...
```text
Implement PR08 — Run read model and query endpoints.
...
- docs/planning/pr1-pr40/prs/PR08-run-read-model-query-endpoints.md
