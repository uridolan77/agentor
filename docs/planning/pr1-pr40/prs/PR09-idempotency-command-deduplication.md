...
Make POST /agent-runs idempotent with Idempotency-Key and request fingerprinting.
...
```text
Implement PR09 — Idempotency and command deduplication.
...
- docs/planning/pr1-pr40/prs/PR09-idempotency-command-deduplication.md
