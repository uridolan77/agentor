...
Create repository contract tests, API integration tests, and first eval fixtures so later PRs are regression-testable.
...
```text
Implement PR10 — Repository, integration, and eval fixture baseline.
...
- docs/planning/pr1-pr40/prs/PR10-repository-integration-eval-fixture-baseline.md
