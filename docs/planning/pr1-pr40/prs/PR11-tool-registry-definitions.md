...
Replace hardcoded fake tool with ToolRegistry and first-class ToolDefinition catalog.
...
```text
Implement PR11 — Tool registry and tool definitions.
...
- docs/planning/pr1-pr40/prs/PR11-tool-registry-definitions.md
