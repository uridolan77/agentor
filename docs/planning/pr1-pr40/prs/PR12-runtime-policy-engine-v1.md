...
Replace allow-all evaluator with simple policy rules for tool risk, allowed tools, and review requirements.
...
```text
Implement PR12 — Runtime policy engine v1.
...
- docs/planning/pr1-pr40/prs/PR12-runtime-policy-engine-v1.md
