...
Standardize tool outputs as ToolResultEnvelope with optional ArtifactRef entries.
...
```text
Implement PR14 — Tool result envelopes and artifact references.
...
- docs/planning/pr1-pr40/prs/PR14-tool-result-envelopes-artifacts.md
