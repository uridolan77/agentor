...
Make denied and review-required tool calls visible and auditable without execution.
...
```text
Implement PR15 — Tool-call audit and policy denial surfaces.
...
- docs/planning/pr1-pr40/prs/PR15-tool-call-audit-policy-denial.md
