...
Add guarded steps that can execute/skip based on prior outputs without adding a script engine.
...
```text
Implement PR18 — Conditional and guarded step execution.
...
- docs/planning/pr1-pr40/prs/PR18-conditional-guarded-step-execution.md
