...
Introduce IKnowledgeStateClient and fake implementation. No live Athanor HTTP yet.
...
```text
Implement PR21 — Athanor client port and fake implementation.
...
- docs/planning/pr1-pr40/prs/PR21-athanor-client-port-fake.md
