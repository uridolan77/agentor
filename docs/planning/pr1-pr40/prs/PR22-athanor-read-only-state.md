...
Implement read-only calls for latest snapshot and canonical lookup behind a client abstraction.
...
```text
Implement PR22 — Athanor read-only canonical state integration.
...
- docs/planning/pr1-pr40/prs/PR22-athanor-read-only-state.md
