...
Submit candidate knowledge proposals to Athanor without canonizing.
...
```text
Implement PR24 — Candidate submission to Athanor.
...
- docs/planning/pr1-pr40/prs/PR24-candidate-submission-athanor.md
