...
Queue candidates for Athanor human review and add tests preventing Agentor canonization paths.
...
This PR is in the Athanor phase. The integration must remain read/candidate/review-only and must not canonize.
...
```text
Implement PR25 — Review queue integration and non-canonization guard.
...
- docs/planning/pr1-pr40/prs/PR25-review-queue-non-canonization-guard.md
