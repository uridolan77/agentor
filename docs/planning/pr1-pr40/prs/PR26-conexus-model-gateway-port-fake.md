...
Introduce IModelGatewayClient and fake deterministic model result.
...
This PR is in the Conexus phase. Model calls must go through Conexus abstractions and never direct provider SDKs.
...
```text
Implement PR26 — Conexus model gateway port and fake implementation.
...
- docs/planning/pr1-pr40/prs/PR26-conexus-model-gateway-port-fake.md
