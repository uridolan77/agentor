...
Expose model calls as governed Agentor tools routed through Conexus.
...
```text
Implement PR27 — Model-call tool through Conexus.
...
- docs/planning/pr1-pr40/prs/PR27-model-call-tool-through-conexus.md
