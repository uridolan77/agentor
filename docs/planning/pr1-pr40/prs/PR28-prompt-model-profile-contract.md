...
Add PromptProfileRef and ModelProfileRef to model-call tools and manifests.
...
```text
Implement PR28 — Prompt/model profile contract.
...
- docs/planning/pr1-pr40/prs/PR28-prompt-model-profile-contract.md
