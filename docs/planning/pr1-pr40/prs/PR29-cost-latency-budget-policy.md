...
Add cost/latency budget policy for tool/model calls.
...
```text
Implement PR29 — Cost, latency, and budget policy.
...
- docs/planning/pr1-pr40/prs/PR29-cost-latency-budget-policy.md
