...
Record provider/model/profile/token/cost telemetry in manifests.
...
```text
Implement PR30 — Model-call telemetry in run manifests.
...
- docs/planning/pr1-pr40/prs/PR30-model-call-telemetry-manifests.md
