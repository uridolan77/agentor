...
Introduce skills as reusable procedural packages, separate from tools.
...
```text
Implement PR31 — Skill package model.
...
- docs/planning/pr1-pr40/prs/PR31-skill-package-model.md
