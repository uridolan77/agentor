...
Invoke skills in runs/plans and record skill trace events.
...
```text
Implement PR32 — Skill invocation pipeline.
...
- docs/planning/pr1-pr40/prs/PR32-skill-invocation-pipeline.md
