...
Add bounded session memory; keep it distinct from Athanor canonical knowledge.
...
```text
Implement PR33 — Session memory boundary.
...
- docs/planning/pr1-pr40/prs/PR33-session-memory-boundary.md
