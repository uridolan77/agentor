...
Bind discovered MCP tools into ToolRegistry through policy wrappers.
...
```text
Implement PR37 — MCP tool discovery and binding.
...
- docs/planning/pr1-pr40/prs/PR37-mcp-tool-discovery-binding.md
