...
Add structured logs, metrics counters, and trace correlation.
...
```text
Implement PR38 — Observability: structured logs, metrics, traces.
...
- docs/planning/pr1-pr40/prs/PR38-observability-logs-metrics-traces.md
