...
Add Dockerfile, docker-compose, CI workflow, and smoke scripts.
...
```text
Implement PR39 — Deployment package, Docker, CI, and smoke tests.
...
- docs/planning/pr1-pr40/prs/PR39-deployment-ci-smoke.md
