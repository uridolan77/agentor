...
Stabilize docs, tests, API surface, and boundaries for v0.1.
...
```text
Implement PR40 — v0.1 release candidate hardening.
...
- docs/planning/pr1-pr40/prs/PR40-v01-release-candidate.md
